	...
	public function render_simple_product_fields() {
		...
		if ( class_exists( 'WC_Subscriptions' ) ) {
			...
			woocommerce_wp_text_input( array(
					...
					'description'   => __( 'For Subscription renwals with a different point value than the signup, enter either a fixed maximum discount amount or percentage which restricts the amount of points that can be redeemed for a discount based on the product price. For example, if you want to restrict the discount on this product to a maximum of 50%, enter 50%, or enter 5 to restrict the maximum discount to $5.  This setting overrides the global/category defaults, use 0 to disable point discounts for this product, and blank to use the global/category default.', 'woocommerce-points-and-rewards' ),
					'desc_tip'      => true,
					'type'          => 'text',
				)
			);
	...
	public function render_variable_product_fields( $loop, $variation_data, $variation ) {
		...
		?>
			<p class="form-row form-row-first">
				<label><?php _e( 'Points Earned', 'woocommerce-points-and-rewards' ); ?><a href="#" class="tips" data-tip="<?php echo esc_attr( $points_earned_description ); ?>">: [?]</a></label>
			...
			<p class="form-row form-row-last">
				<label><?php _e( 'Maximum Points Discount', 'woocommerce-points-and-rewards' ); ?><a href="#" class="tips" data-tip="<?php echo esc_attr( $max_discount_description ); ?>">: [?]</a></label>
			...
			<p class="form-row form-row-full">
				<label><?php _e( 'Change Renewal Points', 'woocommerce-points-and-rewards' ); ?><a href="#" class="tips" data-tip="<?php echo esc_attr( $renewal_points_description ); ?>">: [?]</a></label>
			...
			<tr>
				<td>
					<img style="float: right;" class="help_tip" data-tip="<?php echo esc_attr( $points_earned_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
				...
				<td>
					<img style="float: right;" class="help_tip" data-tip="<?php echo esc_attr( $max_discount_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
			...
			?>
				<tr>
					<td class="show_if_variable-subscription">
						<img style="float: right;" class="help_tip" data-tip="<?php echo esc_attr( $renewal_points_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
		...
		?>
			<tr class="formfield">
				...
				<td>
					...
					<img class="help_tip" data-tip="<?php echo esc_attr( $points_earned_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
				</td>
			</tr>
			<tr class="formfield">
				...
				<td>
					...
					<img class="help_tip" data-tip="<?php echo esc_attr( $max_discount_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
				</td>
			</tr>
		<?php
		if ( class_exists( 'WC_Subscriptions' ) ) {
		?>
			<tr class="formfield">
				...
				<td>
					...
					<img class="help_tip" data-tip="<?php echo esc_attr( $renewal_points_description ); ?>" src="<?php echo esc_url( WC()->plugin_url() . '/assets/images/help.png' ); ?>" height="16" width="16" />
				</td>
			</tr>
		<?php
		} // End if().
